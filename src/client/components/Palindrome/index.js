            ...
            <div className="card">
                ...
                <div className="card-body">
                    <div className="input-group">
                        <label forhtml="value1">Enter the potential palindrome:</label>
                        <input type="text" id="value1" value={val} onChange={e => this.setState({ val: e.target.value })} />
                    </div>
                ...
                <div className="result-container">
                    {this.props.isPalindrome && <p>{`Result: ${this.props.isPalindrome}`}</p>}
                </div>
            </div>
        );
    }
